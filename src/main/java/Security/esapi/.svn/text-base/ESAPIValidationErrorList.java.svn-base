 ...
 */
public class ESAPIValidationErrorList {

    /**
     * Error list of ValidationException's
     */
    private HashMap<String, ESAPIValidationException> errorList = new HashMap<String, ESAPIValidationException>();
     ...
     */
    public void addError(String context, ESAPIValidationException vex) {
        if (context == null) {
     ...
     * @return List
     */
    public List<ESAPIValidationException> errors() {
        return new ArrayList<ESAPIValidationException>(errorList.values());
    }
     ...
     */
    public ESAPIValidationException getError(String context) {
        if (context == null) {
            return null;
        }
